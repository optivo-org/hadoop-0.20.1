...
import org.collectd.protocol.TestReceiver;
...
public class TestMBeanSender
    extends TestCase
    implements Dispatcher {

    private static Logger _log =
        Logger.getLogger(TestMBeanSender.class.getName());
    private MBeanServer _bs =
        ManagementFactory.getPlatformMBeanServer();
    private static final String PLUGIN = "TestMBeanSender";
