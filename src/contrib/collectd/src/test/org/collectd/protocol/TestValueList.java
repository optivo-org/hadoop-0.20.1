...
public class TestValueList extends TestCase {
    ...
    public TestValueList(String testName) {
        super(testName);
    }

    public static Test suite() {
        return new TestSuite(TestValueList.class);
    }
    ...
    private ValueList dummyValueList() {
        ...
        vl.setTime(now);
        vl.setPlugin(PLUGIN);
        vl.setPluginInstance(TestValueList.class.getName());
