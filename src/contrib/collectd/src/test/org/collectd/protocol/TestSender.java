...
public class TestSender
    ...
    private static String PLUGIN_INSTANCE = "TestSender";
    ...
    public static Test suite() {
        return new TestSuite(TestSender.class);
    }
    ...
    protected TestReceiver createReceiverTest() {
        TestReceiver rtest = new TestReceiver();
        return rtest;
    }
    ...
    protected void setUp() throws Exception {
        super.setUp();
        _testReceiver = createReceiverTest();
        _testReceiver.setUp();
        UdpReceiver receiver = _testReceiver.getReceiver();
